...
import { MENUITEMS } from './Sidemenu2';
      ...
      <div className="app-sidebar"    onMouseOver={() => Onhover()}
        ...
        <PerfectScrollbar options={{ suppressScrollX: true, useBothWheelAxes: false }}>
          <div className="side-header">
            ...
            <img src={require("../../assets/smatprop.PNG")} width={50}  alt="logo" />
              <img src={require("../../assets/smatprop.PNG")} width={50} className=" light-logo1" alt="logo" />
                    ...
                    <li className={`slide ${menuItem.selected ? 'is-expanded' : ''}`} key={i}>
                      {menuItem.type === "sub" ? (
                        ...
                        >
                          ...
                          <i style={{color: "#F3764A"}} className={`${menuItem.icon}  side-menu__icon`}></i>
                                            ...
                                            {childrenSubItem.type === "sub" ?
                                              ...
                                              >
                                                ...
                                                {childrenSubItem.active ?
                                                  <i  style={{color: "#F3764A"}} className="sub-angle fa fa-angle-down"></i> : <i className="sub-angle fa fa-angle-right"></i>}
                                              </Link>
                                              :
                                              ""
                                            }
